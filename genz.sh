...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  Script : ${PURPLE} 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐂𝐇𝐀𝐏𝐄𝐄𝐘 𝐒𝐓𝐎𝐑𝐄 ${NC}"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/Amchapeey/strategic/main/keygen | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/Amchapeey/strategic/main/keygen | grep $MYIP | awk '{print $3}')
