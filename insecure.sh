...
echo -e "  Author : ${red}𝐋𝐎𝐑𝐃 𝐂𝐇𝐀𝐏𝐄𝐄𝐘 ${NC}${YELLOW}(${NC} ${grey} CHAPEEY STORE ${NC}${YELLOW})${NC}"
...
wget raw.githubusercontent.com/Amchapeey/strategic/main/limi/limit.sh && chmod +x limit.sh && ./limit.sh
